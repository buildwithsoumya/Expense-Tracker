...
export default function StatsCards({ stats, loading }) {
  ...
  const cards = [
    ...
    { key: 'spend', label: 'Lifetime Spend', value: stats?.total_spend || 0, icon: 'spend', theme: 'amber', prefix: '₹' },
    { key: 'this_month', label: 'This Month', value: stats?.this_month_spend || 0, icon: 'calendar', theme: 'purple', prefix: '₹' },
  ];
